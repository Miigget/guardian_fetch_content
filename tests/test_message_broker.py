...
class TestKinesisPublisher:
    ...
    def test_publish_message_long_title_partition_key(
        self, kinesis_publisher, mock_kinesis_client
    ):
        """Test partition key truncation for long titles."""
        long_title = "Very long article title " * 20  # Over 256 characters
        message = {"webTitle": long_title, "webUrl": "https://example.com/test"}
    ...
    def test_publish_message_no_title_default_partition_key(
        self, kinesis_publisher, mock_kinesis_client
    ):
    ...
    def test_publish_message_kinesis_error(
        self, kinesis_publisher, mock_kinesis_client
    ):
    ...
    def test_publish_message_unicode_content(
        self, kinesis_publisher, mock_kinesis_client
    ):
