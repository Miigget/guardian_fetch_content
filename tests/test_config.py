...
from guardian_content_fetcher.config import (
    ConfigurationError, GuardianConfig, AWSConfig, KinesisConfig, AppConfig,
    load_config_from_env, create_config_dict, setup_logging, validate_aws_credentials,
...
class TestLoadConfigFromEnv:
    ...
    def test_load_config_missing_api_key(self):
        ...
        with patch.dict(os.environ, {}, clear=True):
            with pytest.raises(ConfigurationError, match="GUARDIAN_API_KEY environment variable is required"):
...
class TestConfigurationIntegration:
    ...
    def test_full_config_workflow(self):
        ...
        expected_keys = [
            'guardian_api_key', 'kinesis_stream_name', 'aws_region',
            'aws_access_key_id', 'aws_secret_access_key', 'use_mock_broker', 'log_level'
        ]
