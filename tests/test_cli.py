...
from guardian_content_fetcher.cli import (
    setup_argument_parser, load_configuration, configure_logging, validate_configuration,
    format_output, run_fetch_and_publish, main, run_interactive_mode, CLIError
)
...
class TestRunFetchAndPublish:
    ...
    @patch('guardian_content_fetcher.cli.GuardianContentFetcherFactory.create_with_kinesis')
    ...
    @patch('guardian_content_fetcher.cli.GuardianContentFetcherFactory.create_with_mock')
...
class TestConfigureLogging:
    ...
    def test_configure_logging_verbose(self, mock_get_logger):
        ...
        with patch('logging.getLogger', return_value=mock_root_logger) as mock_get:
...
class TestMainFunction:
    ...
    def test_main_success(self, mock_print, mock_configure_logging, mock_load_config, 
                         mock_validate_config, mock_run_fetch):
    ...
    def test_main_operation_failure(self, mock_load_config, mock_validate_config, mock_run_fetch):
...
class TestRunInteractiveMode:
    ...
    @patch('guardian_content_fetcher.cli.load_configuration')
    @patch('builtins.print')
    def test_run_interactive_mode_success(self, mock_print, mock_load_config, 
                                        mock_validate_config, mock_run_fetch, mock_input):
    ...
    def test_run_interactive_mode_empty_search_term(self, mock_print, mock_input):
        ...
        error_printed = any('Error: Search term cannot be empty' in str(call) 
    ...
    def test_run_interactive_mode_invalid_max_articles(self, mock_print, mock_input):
        ...
        # Should print error message
        error_printed = any('Error: Maximum articles must be a number' in str(call) 
                          for call in mock_print.call_args_list)
        assert error_printed
    ...
    def test_run_interactive_mode_keyboard_interrupt(self, mock_print, mock_input):
        ...
        cancel_printed = any('Operation cancelled' in str(call) 
                           for call in mock_print.call_args_list)
